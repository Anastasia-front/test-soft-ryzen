	...
	return (
		<Section className={s.bg} id="about">
			...
			<div className="flex flex-col gap-[40px] leading-[20px] xl:leading-[24px] xl:w-[920px]">
				<div className="flex flex-col self-start md:self-end gap-[20px] md:gap-[16px] text-14 md:text-16 xl:text-18 font-200 w-[180px] md:w-[220px] xl:w-[292px] md:mt-[-70px] xl:mt-[-85px]">
					<p>
			...
			<div className="flex flex-col gap-[40px] md:gap-[64px] xl:flex-row-reverse xl:gap-[331px] leading-[20px] xl:mt-[72px]">
				<div className="w-[180px] md:w-[220px] xl:w-[298px] text-14 md:text-16 xl:text-18 font-400  self-end md:self-start xl:self-end md:mt-[-60px] xl:mt-0 xl:mt-72px">
